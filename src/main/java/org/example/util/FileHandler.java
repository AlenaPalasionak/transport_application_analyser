        ...
        if (newFilesList.isEmpty()) {
            ...
            for (File file : newFilesList) {
                ...
                if (!(transportationDataItems.length == FileNamePart.NUMBER_OF_ITEMS)) {
                    JOptionPane.showMessageDialog(null, String.format(DialogPaneMessage.WRONG_FILE_NAME_ISSUE, file.getName()));
                }
        ...
        for (File file : newFilesList) {
            ...
            if (flag) {
                ...
                JOptionPane.showMessageDialog(null,
                        String.format(DialogPaneMessage.PLUS_SIGN_ABSENCE_ISSUE, fileName));
            }
        }
    }
